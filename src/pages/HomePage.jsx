...
const countries = [
  { name: 'Canada', flag: 'CA', visas: '12 Visa Types', popular: 'Express Entry', path: '/countries/canada', color: 'from-red-500/20 to-red-600/10' },
  { name: 'Australia', flag: 'AU', visas: '10 Visa Types', popular: 'Skilled Migration', path: '/countries/australia', color: 'from-blue-500/20 to-blue-600/10' },
  { name: 'Germany', flag: 'DE', visas: '8 Visa Types', popular: 'EU Blue Card', path: '/countries/germany', color: 'from-yellow-500/20 to-yellow-600/10' },
  { name: 'UK', flag: 'GB', visas: '9 Visa Types', popular: 'Skilled Worker', path: '/countries/uk', color: 'from-indigo-500/20 to-indigo-600/10' },
  { name: 'USA', flag: 'US', visas: '15 Visa Types', popular: 'H-1B Visa', path: '/countries/usa', color: 'from-blue-600/20 to-red-500/10' },
]
...
function CountryFlag({ country }) {
  ...
  return <span className="text-4xl">{flagEmojis[country]}</span>
}
              ...
              <div>
                ...
                >
                  ...
                  <p className="text-lg text-slate-400 leading-relaxed mb-8 max-w-lg">
                    Expert immigration consulting for work permits, study visas, and permanent residency. 
                    We transform international dreams into reality with a{' '}
